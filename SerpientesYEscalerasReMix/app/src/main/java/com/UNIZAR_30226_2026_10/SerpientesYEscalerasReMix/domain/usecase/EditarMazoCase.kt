...
class EditarMazoCase(
    ...
    suspend operator fun invoke(id: String, nuevoNombre: String?, nuevasCartas: List<Carta>?, eliminarCartas: List<Carta>?) {
        mazosRepository.editarMazo(email.value, id, nuevoNombre, nuevasCartas, eliminarCartas)
    }
}